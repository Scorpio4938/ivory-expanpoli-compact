// ============================================================
// expanpoli_patch_fnc_takedown — takedown tone audio loop
// ============================================================
//
// Hold-to-play dual-dummy tone. Priority if siren active and not
// already priority mode; wail otherwise. Identical to Mean patch.
// ============================================================
