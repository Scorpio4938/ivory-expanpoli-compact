// ============================================================
// expanpoli_patch_fnc_manual — control reference display
// ============================================================
//
// Left-side hint with Expanpoli vehicle controls. Auto-dismisses
// after 8 seconds. Same pattern as Mean patch.
// ============================================================

params [["_car", objNull]];

if (!isNil "expanpoli_patch_manual_dismiss") then { terminate expanpoli_patch_manual_dismiss; };

private _text = parseText (
    "<t size='1.3' align='center'>Expanpoli Vehicle Controls</t><br/>" +
    "<br/>" +
...
expanpoli_patch_manual_dismiss = [] spawn {
    sleep 8;
    hintSilent "";
    expanpoli_patch_manual_dismiss = nil;
};
