// ============================================================
// expanpoli_patch_fnc_sirens — siren audio loop
// ============================================================
//
// Dual-dummy #particlesource + say3D approach (identical to Mean patch).
// Uses Ivory ss2000 sound classes: wail, yelp, priority, hilo.
// ============================================================
